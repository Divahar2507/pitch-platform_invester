...
import { LayoutDashboard, Compass, Briefcase, FileSearch, MessageSquare, Settings, LogOut, TrendingUp, DollarSign, Activity, Users } from 'lucide-react';
...
export const MOCK_STARTUPS: Startup[] = [
  ...
  },
  {
    ...
    location: 'Austin, TX',
    matchScore: 90,
    description: 'Automated cloud infrastructure optimization platform reducing overhead by up to 30%.',
...
export const MOCK_PORTFOLIO: Startup[] = [
  {
    id: 'p1',
    name: 'NexTech AI',
    sector: 'AI / SaaS',
